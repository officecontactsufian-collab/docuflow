            ...
            <form onSubmit={handleSignup}>
              ...
              <CardFooter className="flex flex-col gap-4 pb-8">
                ...
                <div className="pt-4 text-center">
                  <p className="text-[10px] font-bold text-accent/40 uppercase">Already registered? <Link href={`/${locale}/login`} className="text-primary hover:underline italic">Initialize Session <ArrowRight className="inline h-2.5 w-2.5" /></Link></p>
                </div>
              </CardFooter>
            </form>
          </Card>
