            ...
            <form onSubmit={handleEmailLogin}>
              ...
              <CardFooter className="flex flex-col gap-4 pb-8">
                ...
                <div className="pt-4 text-center">
                  <p className="text-[10px] font-bold text-accent/40 uppercase">New to the protocol? <Link href={`/${locale}/signup`} className="text-primary hover:underline italic">Synthesize Account <ArrowRight className="inline h-2.5 w-2.5" /></Link></p>
                </div>
              </CardFooter>
            </form>
          </Card>
