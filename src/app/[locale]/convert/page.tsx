...
function ConvertContent() {
  ...
  const switchProtocol = (type: ConversionType) => {
    reset();
    router.push(`/${locale}/convert?type=${type}`, { scroll: false });
  };
      ...
      <main className="flex-1 flex overflow-hidden">
        <aside className="w-80 border-r border-accent/5 bg-white hidden lg:flex flex-col">
          ...
          <div className="p-6 border-t border-accent/5 bg-muted/5">
             <Button variant="ghost" onClick={() => router.push(`/${locale}/convert`)} className="w-full justify-start h-12 rounded-xl text-[9px] font-black uppercase tracking-widest text-accent/40 hover:text-primary transition-all">
