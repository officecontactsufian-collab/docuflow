...
export default function LoginPage() {
  ...
  React.useEffect(() => {
    // If a user is already logged in (and not anonymous), redirect to dashboard
              ...
              <CardContent className="space-y-4 pt-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="/reset-password" className="text-[9px] font-black uppercase text-primary hover:underline italic">Lost Key?</Link>
                  </div>
                  <Input 
